...
- Region: us-central1 (Iowa) 
    - Zone: us-central1-a
<img src="/screenshots/vm_demo/machine_setup1.png" alt="machine_setup_vm" width="300">


- Machine Size: e2-micro (2 vCPU, 1 core, 1 GB memory)
<img src="/screenshots/vm_demo/machine_setup.png" alt="machine_2_setup_vm" width="300">


- Image (Ubuntu xx.xx): Ubuntu 24.04 LTS Minimal 
<img src="/screenshots/vm_demo/os_setup_sc.png" alt="os_vm" width="300">


- Allow HTTP and HTTPS from networking rules 
<img src="/screenshots/vm_demo/network_rules_vm.png" alt="network_rules_1" width="300">
...
<img src="screenshots/vm_demo/vm_running.png" alt="running" width="300">
...
<img src="/screenshots/vm_demo/firewall_rule.png" alt="firewall_vm" width="300">
<img src="/screenshots/vm_demo/security_access.png" alt="security_vm" width="300">
<img src="/screenshots/vm_demo/ip_filter_vm.png" alt="ip_filters_vm" width="300">
<img src="/screenshots/vm_demo/vm_network_name.png" alt="networks_vm" width="300">
<img src="/screenshots/vm_demo/ports_allowed.png" alt="ports_vm" width="300">



## 3. Commands Used Within the SSH Terminal 
sudo apt update
<img src="/screenshots/vm_demo/sudo_update.png" alt="update_vm" width="300">

###### Updates the SSH operating system 

sudo apt install mysql-server mysql-client nano -y
<img src="/screenshots/vm_demo/install_sql_nano.png" alt="install_vm" width="300">
...
<img src="/screenshots/vm_demo/system_check.png" alt="systemcheck_vm" width="300">

###### Using this command allows us to know if our sql server is active within the SSH Terminal 

sudo systemctl restart mysql 
<img src="/screenshots/vm_demo/system_check.png" alt="restart_sql" width="300">

###### Use this to restart mysql (NOTE: use this after changinf the bind address to 0.0.0.0)

mysql --version 
<img src="/screenshots/vm_demo/sql_version_check.png" alt="version_vm" width="300">

###### Used to find what version of sql we are running in the terminal

mysql -u 'user' -p 
<img src="/screenshots/vm_demo/testing_connection.png" alt="test_post_restart_vm" width="300">
...
<img src="/screenshots/vm_demo/dba_creation.png" alt="database_create_vm" width="300">

###### Used to create a specific database 

SQL QUERY: CREATE USER 
'CREATE USER 'user'@'%' IDENTIFIED BY 'StrongPass123!';'
<img src="/screenshots/vm_demo/create_user_vm.png" alt="create_user_vm" width="300">

###### Used to create a new user

SQL QUERY: GRANT
'GRANT ALL PRIVILEGES ON *.* TO 'user'@'%' WITH GRANT OPTION;'
<img src="/screenshots/vm_demo/grants_ssh_vm.png" alt="grant_user_vm" width="300">

###### used to grant access to users 

SQL query: SHOW DATABASES
<img src="/screenshots/vm_demo/show_databases_vm.png" alt="database_show_vm" width="300">
...
<img src="/screenshots/vm_demo/vm_demo_script_output.png" alt="output_vm" width="300">
...
<img src="/screenshots/vm_demo/error.png" alt="error_vm" width="300">
